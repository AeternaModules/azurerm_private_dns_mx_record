...
output "private_dns_mx_records_name" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.name }
}
output "private_dns_mx_records_record" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.record }
}
output "private_dns_mx_records_resource_group_name" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.resource_group_name }
}
output "private_dns_mx_records_tags" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.tags }
}
output "private_dns_mx_records_ttl" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.ttl }
}
output "private_dns_mx_records_zone_name" {
  ...
  value       = { for k, v in azurerm_private_dns_mx_record.private_dns_mx_records : k => v.zone_name }
}
